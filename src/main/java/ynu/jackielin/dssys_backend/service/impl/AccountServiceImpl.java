...
import ynu.jackielin.dssys_backend.utils.Const;
import ynu.jackielin.dssys_backend.utils.FlowUtils;
...
public class AccountServiceImpl extends ServiceImpl<AccountMapper, Account> implements AccountService {
    ...
    public String registerEmailAccount(EmailRegisterVO vo) {
        ...
        Account account = new Account(null, username, password, email, "student", new Date());
